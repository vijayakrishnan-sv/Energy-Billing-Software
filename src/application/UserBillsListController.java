...
public class UserBillsListController {
	    ...
	    @FXML
	    private TableColumn<BillAndPayment, Double> amount;

	    @FXML
	    private TableColumn<BillAndPayment, LocalDate> enddate;

	    @FXML
	    private TableColumn<BillAndPayment, String> payment;

	    @FXML
	    private TableColumn<BillAndPayment, LocalDate> startdate;
...
public void initialize() throws ClassNotFoundException {
	  ...
	  amount.setCellValueFactory(new PropertyValueFactory<BillAndPayment, Double>("amount"));
	  enddate.setCellValueFactory(new PropertyValueFactory<BillAndPayment, LocalDate>("endDate"));
	  payment.setCellValueFactory(new PropertyValueFactory<BillAndPayment, String>("paymentText"));
	  startdate.setCellValueFactory(new PropertyValueFactory<BillAndPayment, LocalDate>("startDate"));
